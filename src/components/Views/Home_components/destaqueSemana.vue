<template>
  <div>
    <div>
      {{ toqueIntensidade }} | Distância: {{ distancia }}px | {{ direcao }}
    </div>
    <div class="dots">
    ...
    <div
      class="slider"
      v-on:touchstart="handleToqueInicial"
      v-on:touchmove="handleToqueMovimento"
   ...
   */
    ...
    handleToqueFinal(e) {
      ...
      if (this.toqueIntensidade < -1200) {
        ...
        setTimeout(() => {
          this.$refs.Slider.style.transform = "translateX(-1400px)";
        }, 100);
        setTimeout(() => {
          this.$refs.Slider.style.transform = "translateX(-1200px)";
        }, 250);
      }
      if (this.toqueIntensidade > 0) {
        ...
        setTimeout(() => {
          this.$refs.Slider.style.transform = "translateX(200px)";
        }, 100);
        setTimeout(() => {
      ...
      this.$refs.Slider.style.transform =
        "translateX(" + this.toqueIntensidade + "px)";
      //--------------------------------------------------------------------
